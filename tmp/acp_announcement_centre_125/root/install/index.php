...
*
* @package phpBB3
* @version $Id: index.php 278 2011-02-21 14:32:49Z lefty74 $
* @copyright (c) 2008,2011 lefty74
			...
			if (isset($config['acmod_version']))
			{
				switch ($config['acmod_version'])
				{
					...
					case '1.2.3':
						...
						// as of 1.2.4 some db fields have changed, get the old data in the new fields
						$sql_ary = array(
							...
							'announcement_text_uid'		 	=> (string) $announcement['announcement_text_bbcode_uid'],
							'announcement_text_bitfield'	=> (string) $announcement['announcement_text_bbcode_bitfield'],
							'announcement_text_options' 	=> 7,
							'announcement_draft' 			=> (string) $announcement['announcement_draft'],
							'announcement_draft_uid' 		=> (string) $announcement['announcement_draft_bbcode_uid'],
							'announcement_draft_bitfield' 	=> (string) $announcement['announcement_draft_bbcode_bitfield'],
							'announcement_draft_options' 	=> 7,
							...
							'announcement_text_guests_uid' 	=> (string) $announcement['announcement_text_guests_bbcode_uid'],
							'announcement_text_guests_bit' 	=> (string) $announcement['announcement_text_guests_bbcode_bitfield'],
							'announcement_text_guests_opt' 	=> 7,
							);
						$db->sql_query('INSERT INTO ' . ANNOUNCEMENTS_CENTRE_TABLE . ' ' . $db->sql_build_array('INSERT', $sql_ary));
						
						$msg .= '<span style="color:green;">- ' . $user->lang['AC_TABLE_UPDATED'] . '</span><br /><br />';
					...
					/* for the future version upgrade
					case '1.2.4':
						...
						$sql_ary = array(
							...
							'announcement_post_id' 			=> isset($announcement['announcement_post_id']) ? (int)$announcement['announcement_post_id'] : 0,
							'announcement_first_last_post' 	=> isset($announcement['announcement_first_last_post']) ? (string)$announcement['announcement_first_last_post'] : 'DESC',
							'announcement_text_uid'		 	=> (string) $announcement['announcement_text_uid'],
							'announcement_text_bitfield'	=> (string) $announcement['announcement_text_bitfield'],
							'announcement_text_options' 	=> 7,
							'announcement_draft' 			=> (string) $announcement['announcement_draft'],
							'announcement_draft_uid' 		=> (string) $announcement['announcement_draft_uid'],
							'announcement_draft_bitfield' 	=> (string) $announcement['announcement_draft_bitfield'],
							'announcement_draft_options' 	=> 7,
							'announcement_title_guests' 	=> (string) $announcement['announcement_title_guests'],
							'announcement_text_guests' 		=> (string) $announcement['announcement_text_guests'],
							'announcement_text_guests_uid' 	=> (string) $announcement['announcement_text_guests_uid'],
							'announcement_text_guests_bit' 	=> (string) $announcement['announcement_text_guests_bit'],
							'announcement_text_guests_opt' 	=> 7,
							);
						$db->sql_query('INSERT INTO ' . ANNOUNCEMENTS_CENTRE_TABLE . ' ' . $db->sql_build_array('INSERT', $sql_ary));
